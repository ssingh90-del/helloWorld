...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'ssingh90', 'email': 'ssingh90@terpmail.umd.edu', 'first_name': 'Suraj', 'last_name': 'Singh',
         'password': generate_password_hash('ssingh90', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Suraj', 'last_name': 'Singh', 'email': 'ssingh90@terpmail.umd.edu',
         'major_id': 3, 'birth_date': dt.strptime('2004-03-10', '%Y-%m-%d'), 'is_honors': 1}
    ]
